...
async def signup(
    ...
    email_token, email_token_expires_at = auth_service.create_email_token({"sub": user.email})
    ...
    background_tasks.add_task(send_verification_email, user.email, email_token, user_fullname)
    return user
